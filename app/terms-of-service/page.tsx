    ...
    <SmoothScroll>
      ...
      <main className="flex-1 w-full bg-white">
        ...
        <section className="py-20 max-w-4xl mx-auto px-6 text-slate-600 space-y-8 text-sm sm:text-base leading-relaxed">
          <div>
            <h2 className="text-[#0D2B6B] text-xl sm:text-2xl font-bold mb-4">1. Scope of Services</h2>
            <p>
          ...
          <div>
            <h2 className="text-[#0D2B6B] text-xl sm:text-2xl font-bold mb-4">2. Client Cooperation & Site Permissions</h2>
            <p>
          ...
          <div>
            <h2 className="text-[#0D2B6B] text-xl sm:text-2xl font-bold mb-4">3. Data Delivery & Acceptance</h2>
            <p>
          ...
          <div>
            <h2 className="text-[#0D2B6B] text-xl sm:text-2xl font-bold mb-4">4. Limitation of Liability</h2>
            <p>
          ...
          <div>
            <h2 className="text-[#0D2B6B] text-xl sm:text-2xl font-bold mb-4">5. Governing Law</h2>
            <p>
